# Controle de Projetos Integradores do FabLab
...
- Gerenciamento de permissões conforme o papel no FabLab

2. Agenda

- Criação e registro de horários reservados

- Controle de uso de equipamentos ou espaços do FabLab

- Consulta e atualização de agendamentos existentes

3. Projetos

- Cadastro de projetos integradores

- Associação de membros a cada projeto
